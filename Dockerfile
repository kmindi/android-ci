...
RUN echo "y" | sdkmanager "tools" "platform-tools" "build-tools;${ANDROID_BUILD_TOOLS}" "build-tools;26.0.2" \
  ...
  "system-images;android-27;google_apis;x86" "system-images;android-26;google_apis;x86_64" "system-images;android-26;google_apis;x86" "system-images;android-25;google_apis;x86_64" "system-images;android-25;google_apis;x86"  \
